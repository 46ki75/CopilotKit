...
import { CopilotChatConfigurationContextId } from "../../context/copilot-chat-configuration-context";
...
export const CopilotSidebarView = component$<CopilotSidebarViewProps>(
  (props) => {
    return (
      <CopilotChatConfigurationProvider
        isModalDefaultOpen={props.defaultOpen ?? true}
      >
...
const CopilotSidebarViewInternal = component$<
