...
export {
  ...
  type CopilotChatProps as CopilotChatV2Props,
} from "./CopilotChat";
...
} from "./CopilotChatAttachmentQueue";

export {
  CopilotChatAttachmentRenderer,
  type CopilotChatAttachmentRendererProps,
} from "./CopilotChatAttachmentRenderer";

export { ScrollElementContextId } from "./scroll-element-context";
